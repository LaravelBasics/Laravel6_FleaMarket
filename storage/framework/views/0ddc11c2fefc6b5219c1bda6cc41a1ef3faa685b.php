    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-10 offset-1 bg-white">
                ...
                <div class="font-weight-bold text-center border-bottom pb-3 pt-3" style="font-size: 24px">出品した商品|ω・)コソコソ</div>
                        ...
                        <div class="flex-fill p-3">
                            <div>
                                <?php if($item->isStateSelling): ?>
                                    <span class="badge badge-success px-2 py-2">出品中(´っ･ω･)っ</span>
                                <?php else: ?>
                                    <span class="badge badge-dark px-2 py-2">売却済_(:3 」∠)_</span>
                                <?php endif; ?>
