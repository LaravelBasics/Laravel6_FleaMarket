            ...
            <ul class="navbar-nav ml-auto">
                <form class="form-inline" method="GET" action="<?php echo e(route('top')); ?>">
                    <div class="input-group">
                        ...
                        <input type="text" name="keyword" class="form-control" value="<?php echo e($defaults['keyword']); ?>" aria-label="Text input with dropdown button" placeholder="キーワード検索">
                ...
                <li class="nav-item">
                    <a class="btn btn-secondary ml-3" href="<?php echo e(route('register')); ?>" role="button">会員登録</a>
                </li>
                <li class="nav-item">
                    <a class="btn btn-outline-info ml-2" href="<?php echo e(route('login')); ?>" role="button">ログイン</a>
                </li>
                <?php else: ?>
                ...
                <li class="nav-item dropdown ml-2">
                    ...
                    <a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                        ...
                        <img src="<?php echo e(asset('images/' . $user->avatar_file_name)); ?>" class="rounded-circle" style="object-fit: cover; width: 35px; height: 35px;">
                        <?php else: ?>
...
<?php /**PATH /var/www/html/test/mercari_flea_market_laravel6/resources/views/components/header.blade.php ENDPATH**/ ?>