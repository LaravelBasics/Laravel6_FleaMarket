    ...
    <div class="card" style="width: 500px">
        <div class="card-body">
            <div class="font-weight-bold text-center border-bottom pb-3" style="font-size: 24px">パスワード再設定</div>
                <form method="POST" action="<?php echo e(route('password.update')); ?>" class="p-5">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app_only_content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/test/mercari_flea_market_laravel6/resources/views/auth/passwords/reset.blade.php ENDPATH**/ ?>